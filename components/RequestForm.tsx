    ...
    <div className="min-h-screen bg-amber-50 text-stone-700">
      <header className="border-b border-amber-200 bg-white/70">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-4">
          ...
          <Link href="/" className="text-sm text-stone-600 hover:text-green-700">← Back to site</Link>
        </div>
      </header>
      ...
      <main id="main" className="mx-auto max-w-2xl px-5 py-10">
        ...
        <p className="mt-4 flex items-center justify-center gap-2 text-xs text-stone-600">
